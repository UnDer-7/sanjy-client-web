...
public record MealRecordControllerRequestDTO(
    ...
    @JsonPropertyDescription("ID of the chosen diet plan option. Required when isFreeMeal = FALSE, should be NULL when isFreeMeal = TRUE")
    ...
    @Schema(
        ...
        nullable = true,
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonPropertyDescription("Text description of the free meal item. Required when isFreeMeal = TRUE, should be NULL when isFreeMeal = FALSE. Example: Grilled chicken with vegetables")
    ...
    @Schema(
        ...
        nullable = true,
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonPropertyDescription("Unit of measurement for the quantity (serving, g, ml, units, etc...). Defaults to 'serving' if not provided")
    String unit,
    ...
    @Schema(
        ...
        nullable = true,
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonPropertyDescription("Optional field for additional observations or notes about the meal. Example: Extra spicy, no salt")
    String notes
) {
