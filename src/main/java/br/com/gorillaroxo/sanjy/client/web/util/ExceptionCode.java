...
public enum ExceptionCode {
    ...
    FAIL_TO_EXTRACT_TEXT_FROM_PDF_FILE(
            "004", "There was a problem reading your PDF file. Please check the file and try again."),
    FAIL_TO_EXTRACT_TEXT_FROM_PLAIN_TEXT_FILE(
            "005", "There was a problem reading your Plain Text file. Please check the file and try again."),
    ...
    NO_AI_PROVIDER_AVAILABLE(
            "014", "No AI provider is configured. Please configure an AI provider to use this feature."),
    ...
    SERVICE_CONNECTIVITY(
            "017", "Failed to connect to an external service. The service may be temporarily unavailable.");
