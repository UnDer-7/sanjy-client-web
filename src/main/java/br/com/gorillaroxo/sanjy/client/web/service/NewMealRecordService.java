...
public class NewMealRecordService {
    ...
    public MealRecordCreatedControllerResponseDto execute(final MealRecordControllerRequestDto mealRecordRequest) {
        final MealRecordRequestDto dto = mealRecordMapper.toDto(mealRecordRequest);
        final MealRecordCreatedResponseDto response = mealRecordRestClient.newMealRecord(dto);
